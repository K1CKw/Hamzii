    ...
    while True:
        for message_index, message in enumerate(messages):
            ...
            try:
                ...
                os.system('espeak -a 300 "   Hamzii  ,    Tools  ,  Send  ,Convo , "')
                print(Fore.GREEN + f"[+]  Hamzi Tool  KING  {message_index + 1} S3NT TO C0NV0 {target_id} W1TH TOK3N {token_index + 1}: {full_message} at {current_time}")
...
def main():
    approval()
    os.system('espeak -a 300 " Welcome,   to,  Hamzii  ,    Tools  ,  "')
    print(Fore.MAGENTA +"Hamzi  Bashmash ka Tool use kr cikhna non stop hye ")
    print(Fore.CYAN + "------------------------------------")
    ...
    os.system('espeak -a 300 " ENTER   , SEXY , ABUSE  ,  "')
